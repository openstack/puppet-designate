...
describe 'designate::keystone::authtoken' do
  ...
  shared_examples 'designate::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('designate_config').with(
          :username                       => 'designate',
          :password                       => 'designate_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'designate::keystone::authtoken'
    end
  end
